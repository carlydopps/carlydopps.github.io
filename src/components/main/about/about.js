export const About = () => {
    const sections = {
        ...
        personal: {
            ...
            details: [
                `A few years ago, I decided to pursue a college dream of adventuring across the country. I spent two years working remotely and traveling the country in a camper that I renovated. Sometimes we were the only people we knew on a little road of an unknown town in a brand new state, and it taught me so much about enjoying the ups and downs of the adventure and the serendipity of chance encounters.`,
