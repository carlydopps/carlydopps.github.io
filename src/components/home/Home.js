    ...
    return <section id="home">
        <div class="card">
            ...
            <div class="card-img-overlay shadow">
                <div class="header">
                    <h1 class="display-2">Carly Doppelheuer</h1>
                    <p class="fs-6">I'm an adventurous engineer who leans into learning, fails fast, and loves to build together with a team.</p>
                    <div>
                        <button class="btn-icon" onClick={()=> window.open('https://www.linkedin.com/in/carlydopps/', '_blank')}>
                        ...
                        <button class="btn-icon" onClick={()=> window.open('https://github.com/carlydopps', '_blank')}>
                        ...
                        <button class="btn-icon" onClick={()=> window.open('mailto:carly.doppelheuer@gmail.com', '_blank')}>
